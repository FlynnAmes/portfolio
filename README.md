...
- Multi-client electricity demand forecasting pipeline
- Benchmarked statistical, ML, and deep learning approaches (XGBoost, LSTM)
- Identified dominant autoregressive structure via feature analysis

<br>

For those interested in my published work and outreach, these can be found <a href='https://flynnames.github.io/'> here</a>.